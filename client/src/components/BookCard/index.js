    ...
    <div className="col s12 m6 l4">
        <div className="card large amber lighten-4">
          ...
          <div className="card-image">
            ...
            <h4 className="card-title amber lighten-5" style={{ opacity: .6 }}>
              <a className="black-text" href={ props.book.link ? props.book.link : "https://books.google.com/" }>{ props.book.title ? props.book.title : "Book Title" }</a>
            </h4>
            <button className="btn-floating halfway-fab waves-effect waves-light btn" onClick={props.handleSubmit} style={ { bottom: "5px" }}>
